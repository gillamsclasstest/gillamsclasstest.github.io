...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.bakeryNameRefresh=function()
		{
			...
			if (name.indexOf('whyyoucheating',name.length-('whyyoucheating').length)>0 && !Game.sesame) Game.OpenSesame();
		...
		order=11000;
		new Game.Achievement('Tabloid addiction','Click on the news ticker <b>50 times</b>. You found the one and only easter egg I (Mason) put in this!<q>Page 6 : Mad individual clicks on picture of pastry in a futile attempt to escape boredom!<br>Also page 6 : British parliament ate my baby!</q>',[27,7]);
